...
import { DestinationCardPreview } from '@/types/cards';
...
const DestinationCard = ({tab, tripId, _id, title, startDate, startTime, endDate, endTime, 
    removeFromTab} : DestinationCardPreview) => {
            ...
            <View className="pb-5" style={{paddingHorizontal: 18}}>
                <Card style={{padding: 0, borderRadius: 16, width: coverWidth}}>
                    <View className="flex flex-col gap-4">
                        {/* cover */}
                        <View className="w-full rounded-t-xl bg-pink-500 flex items-end justify-center px-3"
